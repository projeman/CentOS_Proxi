...
yukle_3proxy() {
    ...
    URL="https://github.com/projeman/CentOS_Proxi/raw/main/Paketler/3proxy-3proxy-0.8.6.tar.gz"
...
jq_yukle() {
    ...
    wget -qO jq https://github.com/projeman/CentOS_Proxi/raw/main/Paketler/jq-linux64
    chmod +x ./jq
    mv jq /usr/bin
}
